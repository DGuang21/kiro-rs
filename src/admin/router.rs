...
use super::{
    handlers::{
        ...
        get_current_models, get_custom_models, get_global_proxy,
        get_load_balancing_mode, get_log_governance_config, get_proxy_pool, get_retry_config,
        get_self_heal_config, get_update_config, list_client_keys, list_groups, list_traces, poll_idc_login,
        ...
        set_credential_metadata_schema, set_credential_overage,
        set_credential_priority, set_global_proxy, set_load_balancing_mode,
        set_log_governance_config, set_proxy_enabled, set_retry_config, set_self_heal_config,
        set_custom_models, set_update_config,
...
pub fn create_admin_router(state: AdminState) -> Router {
    ...
    let authenticated = Router::new()
        ...
        .route(
            "/config/retry",
            get(get_retry_config).put(set_retry_config),
        )
        .route(
